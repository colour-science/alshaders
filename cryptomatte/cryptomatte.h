...
void create_cryptomatte_aovs_filters_and_outputs(AutomatteData * data) {
    create_cryptomatte_aovs_filters_and_outputs(data->aov_cryptoasset, data->aov_cryptoobject, data->aov_cryptomaterial,
                                                data->aovArray_cryptoasset, data->aovArray_cryptoobject, data->aovArray_cryptoMaterial);
}
