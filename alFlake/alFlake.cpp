...
enum alFlakeParams { p_amount = 0, p_size, p_divergence, p_P, p_space };

enum FlakeSpace { S_TANGENT = 0, S_WORLD };

const char* space_names[] = {"tangent", "world", NULL};
...
shader_evaluate {
    AtVector result = AtVector(0.0f, 0.0f, 1.0f);
