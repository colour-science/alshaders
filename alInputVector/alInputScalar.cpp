...
enum alInputVectorParams { p_input, p_userName, REMAP_FLOAT_PARAM_ENUM };

enum Inputs { IN_facingratio = 0, IN_area, IN_fi, IN_Rl, IN_Rr, IN_USER };

static const char* InputNames[] = {
    "facing-ratio", "area", "face-index", "ray-length",
    "ray-depth",    "User", NULL};
...
shader_evaluate {
    ...
    case IN_Rr:
        ...
        break;
    case IN_USER:
        AiUDataGetFlt(AtString(userName), result);
        break;
    default:
        break;
    }
